    ...
    <div className='bg-[#0A3D62] pt-[7.5rem] pb-[3.256rem] text-white'>
          ...
          >
            <ul className='flex flex-col'>
              ...
              <li className='mt-[1.5rem]'>
                <a href="/#demo" className='text-[2.724rem] transition-colors ease-in-out hover:text-gray-300 '>Demo</a>
              </li>
            </ul>
            <ul className='flex flex-col'>
              <li className='text-[3.541rem] leading-[1] font-bold whitespace-nowrap'>How it Works</li>
              <li className='mt-[1.5rem]'><a href="/#steps" className='text-[2.724rem] transition-colors ease-in-out hover:text-gray-300 '>How it Works</a></li>
            </ul>
            <ul className='flex flex-col'>
              <li className='text-[3.541rem] leading-[1] font-bold'>FAQs</li>
              <li className='mt-[1.5rem]'>
                <a href='/#faq' className='text-[2.724rem] transition-colors ease-in-out hover:text-gray-300 '>FAQs</a>
              </li>
            </ul>
            <ul className='flex flex-col'>
              <li className='text-[3.541rem] font-bold'>Pricing</li>
              <li className='mt-[1.5rem]'>
                <a href="/#pricing" className='text-[2.724rem] transition-colors ease-in-out hover:text-gray-300 '>Pricing</a> </li>
            </ul>
            <ul className='flex flex-col'>
              <li className='text-[3.541rem] font-bold'>Reviews</li>
              <li className='mt-[1.5rem]'><a href="/#reviews" className='text-[2.724rem] transition-colors ease-in-out hover:text-gray-300'>Reviews</a></li>
            </ul>
          </div>
      ...
      <div className='container gap-[15px] md:gap-0 flex flex-col-reverse mt-16 md:flex-row justify-between items-center'>
        <div className='flex items-center text-[#FFFFFFA6] text-[2.4rem] md:text-[2.4rem]'>
          ...
          <Link to='/privacy-policy' className='mr-[2.4rem] transition-colors ease-in-out hover:text-white'>Privacy policy</Link>
          <Link to='/cookie-policy' className='mr-[2.4rem] transition-colors ease-in-out hover:text-white'>Cookies</Link>
        </div>

        <div className='flex items-center gap-[1rem]'>

          <Link to='https://www.linkedin.com/company/arkiter' target='_blank' className='mr-[6.4rem]'>
            <Linkedin className={styles.socialIcon} width={'4.405rem'} height={'4.405rem'} />
          </Link>

          <Link to='https://www.instagram.com/arkiter_com/' target='_blank' className='mr-[6.4rem]'>
            <Inst className={styles.socialIcon} width={'4.032rem'} height={'4.032rem'} />
          </Link>

          <Link to='https://twitter.com/arkiter_com' target='_blank' className='mr-[6.4rem]'>
            <Twitter className={styles.socialIcon} width={'3.0237rem'} height={'2.672rem'} />
          </Link>
