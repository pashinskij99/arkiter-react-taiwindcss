...
const FaqItem = ({question, answer, activeFaq, setActiveFaq, index}) => {
    ...
    return (
        <div
            className={clsx('mb-[3.2rem] border-b-[#0A265F] border-b-2 w-full', {
          ...
          {question}
            ...
            <div
                ...
                <p className='text-[#0A265F] text-[11.3px] md:text-[3.31rem] leading-[4rem] mb-[4rem]'>
                    <div className="content" dangerouslySetInnerHTML={{__html: answer}}></div>
...
const FAQ = () => {
    ...
    const faqData = [
        ...
        {
            question: 'Can you customize the Arkiter interviewing process with your own questions?',
            answer:
