...
const Hero = () => {
    return (
        <div className="relative overflow-hidden">
            <div className="w-full h-auto py-28 bg-[#0A265F] relative">
                ...
                <div className='container'>
                    <div className="flex flex-col max-w-[1000px] justify-center h-full z-[11] relative">
                        <TypographyH1 className='text-white mb-8'>Hire Top Developer Talent With Arkiter</TypographyH1>
                        {/* <h1 className="text-white text-5xl font-[500] leading-[60px] mb-4"></h1> */}
                        <p className="text-white max-w-[759px] text-[28px] mb-8">A brief summary of who this product is for, how they can use
