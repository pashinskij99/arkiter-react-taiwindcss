      ...
      <div className="container relative">
        ...
        <div className='relative'>
          ...
          <div className='absolute top-0 right-0 flex translate-x-[0%] translate-y-[-150%] lg:translate-y-[-230%] lg:translate-x-[-70%]'>
            ...
            >
              <FiArrowLeft size={'2rem'} className={clsx('text-[#FFFFFF54]', {
                ['!text-[#FFFFFF54]']: currentIndex === 0
              })} />
            </button>
            <button
              className={clsx("ml-[1.583rem] w-[5.358rem] h-[5.358rem] flex items-center justify-center rounded-full bg-white text-[#0A3D62]", {
                ['!bg-[#1D9EEB] !border-white border-[.347991rem] ']: currentIndex
              })}
            >
              <FiArrowRight size={'2rem'} color="#0A3D62" className={clsx('text-[#0A3D62]', {
        ...
        <button className='mt-[4rem] ml-[4rem] text-[4.239rem] font-[600] text-white flex items-center'>
...
const Item = () => {
  return (
    <div className="text-white rounded-[2.04592rem] overflow-hidden" style={{ border: '.240697rem solid rgba(255, 255, 255, 0.43)' }}>
      <div className="max-h-[29.846rem] overflow-hidden" style={{borderBottom: '.240697rem solid rgba(255, 255, 255, 0.43)'}}>
      ...
      <div className='pt-[2.768rem] pb-[4.058rem] px-[4.698rem]'>
        ...
        <div className='flex items-center gap-[1.337rem] mt-[1.436rem]'>
          <div
            className='bg-[#313131] leading-[1] flex items-center justify-center text-[1.1rem] font-[600] w-[9.36rem] h-[2.407rem]'
            style={{ border: '0.067rem solid #FFFFFF4F' }}
          >
            Technology
          </div>
          <div
            className='bg-[#49CCF940] leading-[1] flex items-center justify-center text-[1.1rem] font-[600] w-[9.36rem] h-[2.407rem]'
            style={{ border: '0.067rem solid #49CCF982' }}
          >
            Interviews
          </div>
          <div
            className='bg-[#0A3D62] leading-[1] flex items-center justify-center text-[1.1rem] font-[600] w-[9.36rem] h-[2.407rem]'
