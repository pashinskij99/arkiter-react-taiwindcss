  ...
  return (
    <>
      <div className="bg-[#0A265F] h-auto pt-[5.8rem] pb-[9.596rem]">
        <p className="text-center text-white text-[6.6rem] font-[700] mb-10">Speak to us</p>
        <div className="flex flex-col items-center mt-[5.8rem] max-w-[138.0rem] mx-auto">
          ...
          <button className="bg-[#1D9EEB] hover:text-[#0A265F] hover:bg-white mt-[2.9rem] text-[3.41043rem] w-3/4 md:w-1/2 lg:w-1/2 h-[8.57rem] font-semibold rounded-md text-white transition-colors ease-in-out duration-300">
            Contact us
          </button>
        </div>
      </div>
